<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bodycare.aspx.cs" Inherits="ParlourWebsite.Bodycare" %>
...
<meta charset="utf-8">
    ...
    <meta http-equiv="X-UA-Compatible" content="Google Chrome"> <link href="Custom.css" rel="stylesheet" />
...
<body>
   ...
   <div class="about-section">
        <h2 style="font-family: 'Times New Roman', Times, serif; font-size: x-large; font-style: normal; color: #000000; border-width: thin; border-style: none; font-weight: normal;">BODY CARE SERVICES </h2>
        ...
        <div class="container center mt-70">
            <div class="row">
                <div class="col-lg-4"> 
                    ...
                    <div class="box">
                    <img class="img-circle" src="IMAGES/waxxing.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WAXING</h2>
                 ...
                 <div class="col-lg-4">
                    <div class="box">
                    <img class="img-circle" src="IMAGES/Mani.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MANICURE-PEDICURE</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">BOOK YOUR APPOINTMENT</a></p>
                </div></div>

                 <div class="col-lg-4">
                    <div class="box">
                    <img class="img-circle" src="IMAGES/instalight.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INSTA LIGHT PACK</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">BOOK YOUR APPOINTMENT</a></p>
                </div></div>

                 <div class="col-lg-4">
                    <div class="box">
                    <img class="img-circle" src="IMAGES/Bodypolishing.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BODY POLISHING</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">BOOK YOUR APPOINTMENT</a></p>
                </div></div>
         </div>
        </div>
