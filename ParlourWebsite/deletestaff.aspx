<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeFile="DeleteServices.aspx.cs" Inherits="ParlourWebsite.DeleteServices" %>
...
<div class="row">
         ...
         <div class="form-group">
          ...
          <div class="col-md-6">
             ...
             <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"> All Services</h4>
                <br />
