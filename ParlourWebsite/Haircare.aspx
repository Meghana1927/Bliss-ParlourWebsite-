<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Haircare.aspx.cs" Inherits="ParlourWebsite.Haircare" %>
...
<body>
   ...
   <div class="about-section">
        <h2 style="font-family: 'Times New Roman', Times, serif; font-size: x-large; font-style: normal; color: #000000; border-width: thin; border-style: none; font-weight: normal;">HAIR CARE SERVICES </h2>
        ...
        <div class="container center mt-70">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="box">
                    <img class="img-circle" src="IMAGES/HKERATINE.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;KERATINE HAIR SPA</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">ADD TO CART</a></p>
                </div></div>
              
                 <div class="col-lg-4">
                    <div class="box">
                    <img class="img-circle" src="IMAGES/HAIRCOLOUR.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HAIR COLOUR</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">ADD TO CART</a></p>
                </div></div>

                 <div class="col-lg-4">
                    <div class="box">
                    <img class="img-circle" src="IMAGES/hair-spa.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HAIR SPA</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">ADD TO CART</a></p>
                </div>
</div>
                 <div class="col-lg-4">
                    <div class="box">
                    <img class="img-circle" src="IMAGES/HAIRCUTT.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HAIR CUTTING</h2>
                    <p><a class="btn btn-default" href="SignUp.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">ADD TO CART</a></p>
                </div>
         </div>
        </div></div>
