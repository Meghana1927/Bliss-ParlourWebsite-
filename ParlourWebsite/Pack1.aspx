<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pack1.aspx.cs" Inherits="ParlourWebsite.Pack1" %>
...
<body>
   ...
   <div class="about-section" >
        <h1><h2 style="font-family: 'Times New Roman', Times, serif; font-size: x-large; font-style: normal; color: #000000; border-width: thin; border-style: none; font-weight: normal;">BRIDAL PACKAGES </h2>
                  </h1>
    </div>
            <!---BRIDAL PACKAGES--->
           <hr />
        <div class="container mt-70">
            <div class="row">
                <div class="col-lg-4"> 
                    ...
                    <img class="img-circle" src="IMAGES/Engagement.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ENGAGEMENT MAKEUP</h2>
                ...
                <div class="col-lg-4"> 
                    ...
                    <div class="box center">
                    <img class="img-circle" src="IMAGES/Prewedding.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PRE-WEDDING MAKEUP</h2>
                    <p><a class="btn btn-default" href="Signup.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">BOOK YOUR APPOINTMENT</a></p>
                </div>
</div>
                 <div class="col-lg-4">
                    <div class="box center">
                    <img class="img-circle" src="IMAGES/Bridalm.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WEDDING MAKEUP</h2>
                    <p><a class="btn btn-default" href="Signup.aspx" role="button" style="font-family: 'Times New Roman', Times, serif; font-size: small; font-weight: normal; color: #800000">BOOK YOUR APPOINTMENT</a></p>
                </div>
</div>
        ...
        <div class="container mt-70">
             <h2 class="center" style="font-family: 'Times New Roman', Times, serif; font-size: x-large; font-style: normal; color: #000000; border-width: thin; border-style: none; font-weight: normal;">MAKEUP PACKAGES</h2>
            <div class="row">
                <div class="col-lg-4"> 
                    <div class="box center">
                    <img class="img-circle" src="IMAGES/partymkp.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PARTY MAKEUP LOOK</h2>
                    <p><a class="btn btn-default" href="Signup.aspx" role="button">BOOK YOUR APPOINTMENT</a></p>
                </div>
                     </div>

                <div class="col-lg-4">
                    <div class="box center">
                    <img class="img-circle" src="IMAGES/NUDEM.jpg" alt="" width="150" height="150" /> <h2 style="font-family: 'Times New Roman'; font-size: large; font-weight: normal; font-style: normal; color: #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUDE MAKEUP LOOK</h2>
                    <p><a class="btn btn-default" href="Signup.aspx" role="button">BOOK YOUR APPOINTMENT</a></p>
                </div>
                     </div>
         </div>
