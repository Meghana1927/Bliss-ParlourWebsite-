<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true"  Inherits="ParlourWebsite.UpdateStaff" %>
...
<div class="row">
         ...
         <div class="form-group">
          ...
          <div class="col-md-6">
             ...
             <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"> All Staff</h4>
                <br />
                 <asp:TextBox ID="txtFilterGrid1Record" style="border:2px solid blue" CssClass="form-control" runat="server" placeholder="Search Staff...." onkeyup="Search_Gridview(this)"></asp:TextBox>
                <hr />
